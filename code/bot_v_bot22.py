    ...
    while True:
        ...
        if (recvdmssg["type"] == "moverequest"):
            ...
            if OpponentMove['type'] == "pass":
                ...
                opmove.play(gotypes.Point(row= OpponentMove['point']['row'] + 1, col= OpponentMove['point']['col'] + 1))
            ...
            # game = getGameState(configuration["initialState"],configuration["moveLog"],game) #return gamestate
...
def getGameState(initState,movelog,game):
    global G
    G=game
